...
class MainTabBarView: UITabBarController {
    ...
    private func setupTabs() {
        ...
        let findTabViewController = SerachUserTableViewController()
        ...
        followViewController.tabBarItem = UITabBarItem(title: nil, image: resizeImage(imageName: "Light=Activity_Deselect", targetSize: CGSize(width: 24, height: 24)), selectedImage: resizeImage(imageName: "Light=Activity_Select", targetSize: CGSize(width: 24, height: 24)))
